        ...
        initial_messages = [
            {
                ...
                "content": (
                    ...
                    "Every 4-5 tool calls, write a brief progress note to "
                    "`<your-dept>/_wip/PROGRESS.md` using `file_write` in append mode. "
                    "Include: what you've done, decisions made, what remains. "
                    "This survives context pruning and keeps you on track for long tasks.\n\n"
